...
Compared to `sundialr`, `r2sundials` provides:
 ...
 - (as of time of this writing, 2019-11-18) more thorough memory management which ensures that sundials' allocated memory is freed in due way, no matter what C++ exception and in what moment could happen. This avoids potential memory leaking problem in case of frequent package use during the same session.
