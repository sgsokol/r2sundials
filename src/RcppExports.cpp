...
// cvodes
NumericMatrix cvodes(const NumericVector& yv, const vec& times, const RObject& frhs, RObject param, const double abstol, const double reltol, const Nullable<int> integrator_, const int maxord, const int maxsteps, const double hin, const double hmax, const double hmin, const vec& constraints, const RObject fjac, const int nz, const Nullable<int> rmumps_perm_, const int nroot, const RObject froot, const RObject fevent, const int Ns, NumericVector psens, NumericVector psens_bar, const IntegerVector psens_list, const RObject fsens, const RObject fsens1, const Nullable<int> sens_method_, const bool errconS);
RcppExport SEXP _rsundials_cvodes(SEXP yvSEXP, SEXP timesSEXP, SEXP frhsSEXP, SEXP paramSEXP, SEXP abstolSEXP, SEXP reltolSEXP, SEXP integrator_SEXP, SEXP maxordSEXP, SEXP maxstepsSEXP, SEXP hinSEXP, SEXP hmaxSEXP, SEXP hminSEXP, SEXP constraintsSEXP, SEXP fjacSEXP, SEXP nzSEXP, SEXP rmumps_perm_SEXP, SEXP nrootSEXP, SEXP frootSEXP, SEXP feventSEXP, SEXP NsSEXP, SEXP psensSEXP, SEXP psens_barSEXP, SEXP psens_listSEXP, SEXP fsensSEXP, SEXP fsens1SEXP, SEXP sens_method_SEXP, SEXP errconSSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(cvodes(yv, times, frhs, param, abstol, reltol, integrator_, maxord, maxsteps, hin, hmax, hmin, constraints, fjac, nz, rmumps_perm_, nroot, froot, fevent, Ns, psens, psens_bar, psens_list, fsens, fsens1, sens_method_, errconS));
...
static const R_CallMethodDef CallEntries[] = {
    {"_rsundials_cvodes", (DL_FUNC) &_rsundials_cvodes, 27},
