...
//' convert some subset of R to C++ code. The result can be a pointer to a compiled C++ function which can be directly used in \code{r2cvodes()}. A tutorial is available at https://konrad1991.github.io/ast2ast-examples/ .\cr
