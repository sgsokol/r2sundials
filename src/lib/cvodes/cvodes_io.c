...
#define fprintf(outf,...) Rprintf(__VA_ARGS__)
...
char* CVodeGetReturnFlagName(long int flag)
{
  ...
  switch (flag)
  {
  case CV_SUCCESS: snprintf(name, 23, "CV_SUCCESS"); break;
  case CV_TSTOP_RETURN: snprintf(name, 23, "CV_TSTOP_RETURN"); break;
  case CV_ROOT_RETURN: snprintf(name, 23, "CV_ROOT_RETURN"); break;
  case CV_TOO_MUCH_WORK: snprintf(name, 23, "CV_TOO_MUCH_WORK"); break;
  case CV_TOO_MUCH_ACC: snprintf(name, 23, "CV_TOO_MUCH_ACC"); break;
  case CV_ERR_FAILURE: snprintf(name, 23, "CV_ERR_FAILURE"); break;
  case CV_CONV_FAILURE: snprintf(name, 23, "CV_CONV_FAILURE"); break;
  case CV_LINIT_FAIL: snprintf(name, 23, "CV_LINIT_FAIL"); break;
  case CV_LSETUP_FAIL: snprintf(name, 23, "CV_LSETUP_FAIL"); break;
  case CV_LSOLVE_FAIL: snprintf(name, 23, "CV_LSOLVE_FAIL"); break;
  case CV_RHSFUNC_FAIL: snprintf(name, 23, "CV_RHSFUNC_FAIL"); break;
  case CV_FIRST_RHSFUNC_ERR: snprintf(name, 23, "CV_FIRST_RHSFUNC_ERR"); break;
  case CV_REPTD_RHSFUNC_ERR: snprintf(name, 23, "CV_REPTD_RHSFUNC_ERR"); break;
  case CV_UNREC_RHSFUNC_ERR: snprintf(name, 23, "CV_UNREC_RHSFUNC_ERR"); break;
  case CV_RTFUNC_FAIL: snprintf(name, 23, "CV_RTFUNC_FAIL"); break;
  case CV_MEM_FAIL: snprintf(name, 23, "CV_MEM_FAIL"); break;
  case CV_MEM_NULL: snprintf(name, 23, "CV_MEM_NULL"); break;
  case CV_ILL_INPUT: snprintf(name, 23, "CV_ILL_INPUT"); break;
  case CV_NO_MALLOC: snprintf(name, 23, "CV_NO_MALLOC"); break;
  case CV_BAD_K: snprintf(name, 23, "CV_BAD_K"); break;
  case CV_BAD_T: snprintf(name, 23, "CV_BAD_T"); break;
  case CV_BAD_DKY: snprintf(name, 23, "CV_BAD_DKY"); break;
  case CV_NO_QUAD: snprintf(name, 23, "CV_NO_QUAD"); break;
  case CV_QRHSFUNC_FAIL: snprintf(name, 23, "CV_QRHSFUNC_FAIL"); break;
  case CV_FIRST_QRHSFUNC_ERR: snprintf(name, 23, "CV_FIRST_QRHSFUNC_ERR"); break;
  case CV_REPTD_QRHSFUNC_ERR: snprintf(name, 23, "CV_REPTD_QRHSFUNC_ERR"); break;
  case CV_UNREC_QRHSFUNC_ERR: snprintf(name, 23, "CV_UNREC_QRHSFUNC_ERR"); break;
  case CV_BAD_IS: snprintf(name, 23, "CV_BAD_IS"); break;
  case CV_NO_SENS: snprintf(name, 23, "CV_NO_SENS"); break;
  case CV_SRHSFUNC_FAIL: snprintf(name, 23, "CV_SRHSFUNC_FAIL"); break;
  case CV_FIRST_SRHSFUNC_ERR: snprintf(name, 23, "CV_FIRST_SRHSFUNC_ERR"); break;
  case CV_REPTD_SRHSFUNC_ERR: snprintf(name, 23, "CV_REPTD_SRHSFUNC_ERR"); break;
  case CV_UNREC_SRHSFUNC_ERR: snprintf(name, 23, "CV_UNREC_SRHSFUNC_ERR"); break;
  case CV_TOO_CLOSE: snprintf(name, 23, "CV_TOO_CLOSE"); break;
  case CV_NO_ADJ: snprintf(name, 23, "CV_NO_ADJ"); break;
  case CV_NO_FWD: snprintf(name, 23, "CV_NO_FWD"); break;
  case CV_NO_BCK: snprintf(name, 23, "CV_NO_BCK"); break;
  case CV_BAD_TB0: snprintf(name, 23, "CV_BAD_TB0"); break;
  case CV_REIFWD_FAIL: snprintf(name, 23, "CV_REIFWD_FAIL"); break;
  case CV_FWD_FAIL: snprintf(name, 23, "CV_FWD_FAIL"); break;
  case CV_GETY_BADT: snprintf(name, 23, "CV_GETY_BADT"); break;
  case CV_NLS_FAIL: snprintf(name, 23, "CV_NLS_FAIL"); break;
  default: snprintf(name, 23, "NONE");
  }
